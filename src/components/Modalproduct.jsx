        ...
        >
          <Modal.Dialog size='lg'>
            ...
            <Modal.Footer style={{ backgroundColor: "rgb(103,11,9)" }}>
              <Link to={`/editProduct/${p.id}`}><Button variant="secondary" style={{ backgroundColor: "#d63384" }}>Editar</Button></Link>
              <Link to={"/"}><Button variant="secondary" style={{ backgroundColor: "#d63384" }}>Inicio</Button></Link>
              <Link to={"/"}><Button variant="secondary" style={{ backgroundColor: "#d63384" }} onClick={() => deleteProduct(p.id)}>Eliminar</Button></Link>
            </Modal.Footer>
          </Modal.Dialog>
        </div>
      ))}
